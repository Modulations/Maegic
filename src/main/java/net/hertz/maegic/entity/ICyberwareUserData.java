...
public interface ICyberwareUserData {
    List<ItemStack> getInstalledCyberware(ICyberware.EnumRegion slot);
    void setInstalledCyberware(LivingEntity livingEntity, ICyberware.EnumRegion slot, List<ItemStack> cyberware);
    //void setInstalledCyberware(LivingEntity livingEntity, ICyberware.EnumRegion slot, NonNullList<ItemStack> cyberware);
    boolean isCyberwareInstalled(ItemStack cyberware);
    int getCyberwareRank(ItemStack cyberware);

    NbtCompound serializeNBT();
    void deserializeNBT(NbtCompound nbtTag);
    ...
    void setHudData(NbtCompound nbtTag);
